...
/**
 * Base container class for cfc containers with automatic sizing.
 * Handles layout of child elements and adjusts width/height accordingly.
 */
export abstract class CfcContainer extends UMLContainer {
  ...
  private autoWidth(canvas: ILayer, children?: ILayoutable[]): void {
    ...
    const nameWidth = Text.size(canvas, title, { fontWeight: 'bold' }).width + 20;
